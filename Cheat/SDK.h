...
struct AController {
	...
	char pad_0000[0x3e0]; //0x0000
	class ACharacter* Character; //0x3e0(0x08)
	char pad_0480[0x458]; // 0x490
	APlayerCameraManager* PlayerCameraManager; //0x0500 Come Back 0x458(0x08)
